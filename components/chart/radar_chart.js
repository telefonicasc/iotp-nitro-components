                ...
                this.updateChart = function() {
                    ...
                    axisLines
                        ...
                        .attr('transform', function(d, i) {
                                ...
                                return 'rotate(' + angle + ',' + radarX +
                                    ',' + radarY + ')';
                            });

                    axisCircles.enter().append('circle').attr('r', 4);
                    axisCircles.attr('cx', function(d, i) {
                        return getX(maxValues[i], i);
                    });
                    axisCircles.attr('cy', function(d, i) {
                        return getY(maxValues[i], i);
                    });
                    axisCircles.exit().remove();

                    axisLabels.enter().append('text');
                    axisLabels.attr('x', function(d, i) {
                        return getX(maxValues[i], i);
                    });
                    ...
                    radarG.enter().append('g')
                        ...
                        .append('path');
                    radarG.select('path').attr('d', function(d) {
                        return radarLine(d.values) + 'Z';
                    });
                    circles = radarG.selectAll('circle').data(function(d) {
                        return d.values;
                    });
