 ...
 * - marker_click_event [default:'marker-clicked'] => flight event to trigger when a marker is clicked
 ...
 * ==> Flight events:
 * [SENT] 
 * config.marker_click_event :: Sent when a marker is clicked
 *
 * [RECEIVED]
    ...
    function Map() {
        ...
        this.after('initialize', function() {
                ...
                function(model) {
                    ...
                    MM.addEvent(elem, 'click',
                        function () {
                            ...
                            // Update markers
                            self.trigger('update-marker-views', {title:elem.alt});
                            // Trigger the event specified
                            self.trigger(self.attr.marker_click_event, {text: elem.alt});
                        } 
                    );
            ...
            if (self.attr.debug) {
                ...
                // TEST
                this.on(this.attr.marker_click_event, function (event,payload) {
            ...
            this.on('update-marker-model', function (event, payload) {
                var index = self.findMarker(payload.title);
            ...
            this.on('update-marker-views', function (event, payload) {
                ...
                i = self.findMarker(payload.title);
                if (i < 0) {
            ...
            this.findMarker = function (markerid) {
                ...
                while (i < self.attr.features.length && !found) {
                    ...
                    if (self.attr.features[i].properties.title == markerid) {
                        found = true;
                    }
                    else i++;
                }
